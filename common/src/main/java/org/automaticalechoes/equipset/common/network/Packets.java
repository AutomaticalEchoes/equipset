...
public class Packets {
    public static final ResourceLocation FEED_BACK = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID,"feed_back");
    public static final ResourceLocation SERVER_CONFIG = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID,"server_config");
    public static final ResourceLocation UPDATE_PRESET = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID,"update_preset");
    public static final ResourceLocation UPDATE_PRESET_PART_STATUS = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID,"update_preset_status");
    public static final ResourceLocation UPDATE_PRESET_NAME = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID,"update_preset_name");
