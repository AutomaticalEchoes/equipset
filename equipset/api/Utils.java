...
public class Utils {
    public static final TranslatableComponent Total = new TranslatableComponent("tip.equipset.total");
    public static final TranslatableComponent LackPart = (TranslatableComponent) new TranslatableComponent("tip.equipset.lack_part").withStyle(ChatFormatting.RED);
    public static final TranslatableComponent CursePart = (TranslatableComponent) new TranslatableComponent("tip.equipset.curse_part").withStyle(ChatFormatting.RED);
    public static final TranslatableComponent NoneSet = (TranslatableComponent) new TranslatableComponent("tip.equipser.none_set").withStyle(ChatFormatting.RED);
    public static final TranslatableComponent LockSet = (TranslatableComponent) new TranslatableComponent("tip.equipser.lock_set").withStyle(ChatFormatting.RED);
