...
public class PresetEquipPart {
    ...
    public boolean isCurse(ServerPlayer serverPlayer, BaseComponent component){
    ...
    public boolean canFindPresetItem(ServerPlayer serverPlayer, BaseComponent component){
