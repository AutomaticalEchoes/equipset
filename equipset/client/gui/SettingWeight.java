...
public class SettingWeight extends AbstractWidget {
    protected static final Component COMPONENT_CLEAR = new TranslatableComponent("button.equipset.clear");
    protected static final Component COMPONENT_SAVE = new TranslatableComponent("button.equipset.save");
    protected static final Component COMPONENT_LOCK = new TranslatableComponent("button.equipset.lock");
    protected static final Component COMPONENT_UNLOCK = new TranslatableComponent("unlock");
    protected static final Component COMPONENT_DELETE = new TranslatableComponent("button.equipset.delete");
    ...
    public SettingWeight(Font font, int x, int y, int w, int h, int id) {
        ...
        IButton change = new IButton(lineX_1,  lineY_1 + 1, 10, 10, new TextComponent(String.valueOf(id)), p_93751_ -> Actions.SendUsePreset(id));
        NameEdit = new IEditBox(font, this.x + 17,  lineY_1 + 2, 64, 8, TextComponent.EMPTY, name -> {
